...
% assume the data is already zero-meaned
[u, s, v] = svd(cov(x'));
...
% project x onto the first eigenbasis
xHat = u(:, 1:k)' * x;
% recover data from 1-dimension to 2-dimension
xHat = u(:, 1:k) * xHat;
...
% check whether the covariance matrix is identity matrix
% cov(xPCAWhite')
% pause;
%%================================================================
